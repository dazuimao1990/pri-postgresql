...
ALTER TABLE public.cluster_ca OWNER TO kong;
...
COPY public.routes (id, created_at, updated_at, service_id, protocols, methods, hosts, paths, regex_priority, strip_path, preserve_host, name, snis, sources, destinations, tags, https_redirect_status_code, headers) FROM stdin;
\.
...
COPY public.upstreams (id, created_at, name, hash_on, hash_fallback, hash_on_header, hash_fallback_header, hash_on_cookie, hash_on_cookie_path, slots, healthchecks, host_header, tags, algorithm) FROM stdin;
\.
